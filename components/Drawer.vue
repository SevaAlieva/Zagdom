<template>
  <div class="drawer__burger">
      ...
      <div v-show="isOpen" class="drawer__menu">
        ...
        <div class="drawer__contacts">
          <div class="drawer__phone">
            <img class="drawer__phone-icon" src="/icons/phone2.svg" alt="Телефон">
            <a href="tel:+79009009090" class="drawer__phone-number">+7 (900) 900-90-90</a>
          </div>
          <div class="drawer__email">
            <img class="drawer__email-icon" src="/icons/email2.svg" alt="Почта">
            <a href="mailto:info@gmail.com">info@gmail.com</a>
          </div>
          <div class="drawer__address">
            <img class="drawer__address-icon" src="/icons/location2.svg" alt="Адрес">
    ...
    <transition name="fade">
      <div v-show="isOpen" class="drawer__overlay" @click="closeMenu"></div>
    </transition>
  </div>
</template>
